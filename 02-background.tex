...
\citep{Pilotto2015}. No projection is computed in this thesis: the MUW data
already provide the lesion mask and the layer depth maps on the en-face grid
(\S\ref{sec:data:dataset}).
