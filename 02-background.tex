...
Two acquisition platforms dominate the GA literature.
Spectral-domain OCT (SD-OCT) operates around an 870\,nm wavelength and
reaches an axial resolution of roughly 3--6\,\textmu{}m
\citep{Boopathiraj2024,Pilotto2015}, sufficient to resolve the
principal retinal layer boundaries from inner limiting membrane to
Bruch's membrane. Swept-source OCT (SS-OCT), operating at approximately
1050\,nm and at A-scan rates above 100\,kHz, reaches deeper into the
choroid with a 5.5\,\textmu{}m axial resolution at the cost of slightly
coarser lateral sampling \citep{Chu2022}. \citet{Vallino2024} argue
that OCT is the modality of choice for GA over fundus
autofluorescence (FAF) for three reasons: it provides
cross-sectional images amenable to detailed quantitative analysis of
each retinal layer, it detects atrophic processes earlier in their
natural history, and it is reliable in the foveal region where blue-FAF
struggles. The thesis modelling substrate is therefore OCT-derived,
not FAF-derived, with \citet{Pilotto2015} providing the empirical
guarantee that en-face OCT GA-area measurements reach inter-operator
intraclass correlation coefficients of 0.97--0.99 and are statistically
equivalent to B-FAF and near-infrared FAF on small cohorts.
...
The full SD-OCT volume of a GA eye is too large and too redundant to be
...
\citet{Chu2022} (Zeiss PLEX Elite 9000 SS-OCT, $6 \times 6$\,mm scan
...
with weights shared across the spatial dimensions. It is applied along
the temporal-bundle axis to decode the final latent state into a
sequence of updates $d_i = (d_i^1, \dots, d_i^K)$. A residual update
